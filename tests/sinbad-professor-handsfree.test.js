...
test('main app opens the resizable hands-free Professor window and Pages ships its assets',()=>{
  ...
  for(const file of ['academy-professor-v3.html','academy-professor-handsfree.css','academy-professor-handsfree.js','academy-professor-native.html','academy-professor-native.css','academy-professor-native.js','sinbad-speaker-identity.js','sinbad-tutor-orchestrator.js','sinbad-tutor-controller.js'])assert.match(release,new RegExp(file.replaceAll('.','\\.')));
});
