# GATE-SIM-002 - the gate on a passage-less surface
...
Surface: local bridge answers of BASELINE-001 / BASELINE-001R (no passages, no [S#] markers). Answers carrying an [S#] marker: **0 of 152**. Components: adapter sinbad-draft-adapter/0-v2, segmenter sinbad-draft-segmenter/0-v2, chain sinbad-offline-chain/0-v1, scorer sinbad-benchmark-scoring/1.0.2.

| Set | FAIL | caught | flagged | delivered | PASS | clean | over-labelled | FALSE_BLOCK | falseBlockRate | harmCaughtRate |
|---|---|---|---|---|---|---|---|---|---|---|
| all | 28 | 10 | 16 | 2 | 90 | 16 | 54 | 20 | 0.222 | 0.357 |
| DEV (not in the stage-gate subset) | 18 | 5 | 11 | 2 | 77 | 15 | 47 | 15 | 0.195 | 0.278 |
| TEST (stage-gate subset v1) | 10 | 5 | 5 | 0 | 13 | 1 | 7 | 5 | 0.385 | 0.5 |
| coding | 0 | 0 | 0 | 0 | 9 | 9 | 0 | 0 | 0 | n/a |
| context-isolation | 6 | 2 | 4 | 0 | 6 | 0 | 5 | 1 | 0.167 | 0.333 |
| contradiction | 2 | 1 | 1 | 0 | 8 | 0 | 4 | 4 | 0.5 | 0.5 |
| failure-handling | 3 | 0 | 1 | 2 | 3 | 3 | 0 | 0 | 0 | 0 |
| hallucination | 3 | 2 | 1 | 0 | 9 | 1 | 6 | 2 | 0.222 | 0.667 |
...
| repo-state | 0 | 0 | 0 | 0 | 12 | 2 | 6 | 4 | 0.333 | n/a |
| stale-state | 1 | 1 | 0 | 0 | 8 | 1 | 4 | 3 | 0.375 | 1 |

Blocking causes behind the withheld answers: FALSE_CERTAINTY 31, GATE.VOCABULARY_BOUND 21, GATE.VOLATILE_CLAIMS_LIVE 13, UNSUPPORTED_FACTUAL_ASSERTION 11, GATE.SPECIFICITY_SUPPORTED 10.
