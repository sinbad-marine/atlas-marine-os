...
test('native Academy owns a bounded live Sinbad board-teaching stage',()=>{
  ...
  assert.match(academyHtml,/sinbad-performance-director\.js\?v=82019/);assert.match(academyHtml,/academy-window\.js\?v=82021/);assert.match(academyHtml,/academy\.css\?v=82019/);
  ...
  assert.match(worker,/sinbad-marine-v8\.20\.19-semantic-listening-v32/);
});
