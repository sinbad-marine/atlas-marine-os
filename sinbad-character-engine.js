(function(root,factory){
  ...
  const GESTURES=Object.freeze(['rest','idle-breathe','idle-look-left','idle-look-right','open-hand','show-palm','raise-left','wave-right','wave-right-away','look-left','look-right','explain','laugh','walk','point-board','nod','listen-lean','listen-orient','listen-follow','hold']);
