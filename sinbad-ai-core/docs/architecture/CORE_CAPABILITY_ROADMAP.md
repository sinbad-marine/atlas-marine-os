...
- Continue the inert pedagogy workstream from ADR-0036/0037/0038: the learning/animation boundary and its sensitive-data/truth/consent-candidate composition exist, while informed-consent verification, scoped truth custody, adaptive instruction, competency authority and rendering remain blocked.
