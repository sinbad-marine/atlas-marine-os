...
1. Truth/safe-stop/execution-state and versioned task-memory contracts. **Current: Runtime Foundation 1 (ADR-0009), NOT PRODUCTION READY / BLOCKED; inert contracts present and the blocker remains open.**
