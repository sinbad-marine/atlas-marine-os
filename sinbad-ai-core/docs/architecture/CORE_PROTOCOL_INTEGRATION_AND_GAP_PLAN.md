...
7. Pedagogy/learning/animation-intent separation without live capture or biometrics. **Current: Pedagogy Foundation v1 (ADR-0036–0040), NOT PRODUCTION READY / TERMINALLY DENIED; learning, governance, consent, competency/review and renderer-evidence candidate graphs are inert, and no adaptive instructor, renderer, recognition, capture, certification or competency authority exists.**
