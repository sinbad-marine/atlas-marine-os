...
2. Sensitive-data classification, consent/retention/export/delete and isolation gates. **Current: Foundation 1 (ADR-0012), NOT PRODUCTION READY / BLOCKED; classification/policy/action/isolation candidates are inert and no export, deletion, erasure, consent verification, or durable audit capability exists.**
3. Engineering artifact/unit/coordinate/provenance and DRAFT-only contracts. **Current: Engineering Foundation 1 (ADR-0013), NOT PRODUCTION READY / BLOCKED; artifact, rational-unit, coordinate-frame, and measurement-provenance records are inert and no solver, transform, verification, validation, or approval authority exists.**
4. Calculation-chain/V&V state machine with independent-check and uncertainty evidence. **Current: Engineering Foundation 2 (ADR-0014), NOT PRODUCTION READY / BLOCKED; calculation, independent-check, verification, and validation candidates are inert and no solver execution, VERIFIED/VALIDATED state, or approval authority exists.**
5. Digital-twin layer identity and scan provenance without geometry generation. **Current: Digital Twin Foundation 1 (ADR-0015), NOT PRODUCTION READY / BLOCKED; scan, model-layer, deviation, and twin-state candidates are inert and no capture processing, SLAM, registration, geometry generation, AR/VR/MR, or living-twin runtime exists.**
6. Stability/Load Master input and test-condition contracts without calculations or approval states. **Current: Stability Foundation v1 (ADR-0027–0035), NOT PRODUCTION READY / TERMINALLY DENIED; DRAFT package and typed sources, test/loading candidates, reference/independent-check candidates, criteria/uncertainty candidates, integrity composition, ephemeral evidence/custody and a terminal release/activation denial are present. No stability solver, criteria engine, official Stability Booklet, approved loading computer, durable custody, publication or operational authority exists.**
7. Pedagogy/learning/animation-intent separation without live capture or biometrics. **Current: Pedagogy Foundation 1 (ADR-0036), NOT PRODUCTION READY / BLOCKED; learning-profile, lesson-state, pedagogy-decision and animation-intent candidates are inert, animation cannot claim knowledge authority or request identity/biometric/live capture, and no adaptive instructor, renderer, recognition, capture or competency authority exists.**
