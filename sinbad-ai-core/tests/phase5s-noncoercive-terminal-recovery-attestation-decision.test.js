...
function options() { return { serviceRole: true, actorHash: 'a'.repeat(64), client: { rpc: async () => ({ data: [], error: null }) }, limit: 10, slaMs: 120000, pageSize: 10, maxEvents: 100, ttlMs: 5000, purpose: 'terminal-rollout', now: () => 1000 }; }
