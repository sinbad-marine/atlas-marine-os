...
const AUTHORIZATION_VERSION='sinbad-trusted-terminal-rollout-recovery-authorization/3M-v1';
...
function create(options={}){
  if(typeof options.authorize!=='function')throw new TypeError('A trusted authorize function is required');
...
module.exports=Object.freeze({AUTHORIZATION_VERSION,EXPECTED_RECOVERY_VERSION,create});
