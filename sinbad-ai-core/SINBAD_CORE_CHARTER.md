...
The user-approved truth/memory, engineering/digital-twin, and trainer/voice protocols are incorporated through [CORE_PROTOCOL_INTEGRATION_AND_GAP_PLAN.md](./docs/architecture/CORE_PROTOCOL_INTEGRATION_AND_GAP_PLAN.md). They are binding requirements, but do not authorize immediate activation, engineering approval, voice synthesis/deletion, navigation, or physical control. Conflicts fail closed under this charter.
