...
function evaluate(input){
  ...
  try{
    ...
    const assessment=governance.evaluateApprovalScope({expectedTenantId:r.expectedTenantId,expectedVesselId:r.expectedVesselId,expectedRequirementId:r.expectedRequirementId,expectedApprovalId:review.approvalId,expectedEvidenceId:evidence.evidenceId,expectedNow:r.expectedNow,approval:review,evidence});
