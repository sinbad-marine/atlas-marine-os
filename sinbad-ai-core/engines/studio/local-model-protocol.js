...
function parseResponse(request,payload){
  if(!request||request.status!=='LOCAL_MODEL_REQUEST_READY'||request.mode!==MODE||!Object.isFrozen(request))throw new TypeError('AUTHENTIC_REQUEST_SHAPE_REQUIRED');
...
module.exports=freeze({VERSION,MODE,MAX_PROMPT_BYTES,MAX_RESPONSE_BYTES,ALLOWED_PATHS,validateEndpoint,createRequest,parseResponse});
