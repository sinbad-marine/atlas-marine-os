...
module.exports=freeze({
  ...
  runtimeEvidence:{observedAt:'2026-08-21',runtime:'Ollama',runtimeVersion:'0.32.15',model:'qwen3:14b',modelDigest:'sha256:bdbd181c33f2ed1b31c972991882db3cf4d192569092138a7d29e973cd9debe8',modelSizeBytes:9276198565,format:'gguf',family:'qwen3',parameterSize:'14.8B',quantization:'Q4_K_M',licensePresent:true,templateHash:'sha256:ae370d884f108d16e7cc8fd5259ebc5773a0afa6e078b11f4ed7e39a27e0dfc4',processorObserved:'100% CPU',probeResult:'PRO_MODEL_PROPOSAL_READY',probeArtifact:'web/index.html',persisted:false,published:false,portableClaim:false},
  activationBlockers:[{code:'LOCAL_MODEL_INFERENCE_NOT_SANDBOX_ISOLATED',detail:'The installed Ollama runtime is loopback-only but model inference has not yet been reproduced inside a separately resource-bounded, network-denied runtime. The verified Docker sandbox remains limited to hash-bound generated software tests.',blocks:['PROFESSIONAL_OFFLINE_MODEL_ACTIVATION','UNATTENDED_MODEL_INFERENCE']}],
