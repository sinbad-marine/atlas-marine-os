...
module.exports=freeze({
  version:'0.3.1',status:'PRO_STUDIO_REVIEW_AND_REVISION_FOUNDATION_ACCEPTED',scope:'AUTHENTIC_MODEL_PROPOSAL_TO_NO_DELETE_DERIVED_REVISION',
  ...
  historicalExecutionBlocker:{code:'NO_NETWORK_ISOLATING_CODE_SANDBOX',observedBefore:'2026-08-21',decisionAtObservation:'KEEP_GENERATED_EXECUTION_BLOCKED',resolvedForExactVerifiedSoftwareTestsBy:'PRO_STUDIO_DOCKER_TEST_EVIDENCE_ACCEPTED@0.4.4',stillBlocked:['GENERAL_COMMAND_EXECUTION','WEB_OR_ANIMATION_SCRIPT_EXECUTION','UNVERIFIED_GENERATED_CODE','MODEL_INFERENCE_ISOLATION']},
