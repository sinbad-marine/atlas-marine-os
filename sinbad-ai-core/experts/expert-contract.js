(function(root,factory){
  ...
  function normalize(input={}){
    ...
    for(const field of ['execute','canHandle']){
      ...
      if(descriptor&&(!Object.hasOwn(descriptor,'value')||(descriptor.value!==null&&descriptor.value!==undefined)))throw new TypeError(`expert ${field} callbacks are forbidden in Core`);
    }
