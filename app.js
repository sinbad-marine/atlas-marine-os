...
async function sendToSinbad(text){
  ...
  if(boardCheck?.accepted){sinbadPendingAcademyBoardCheck=boardCheck.known?Object.freeze({...boardCheck.check,question:boardCheck.text,attempts:0}):null;presentSinbadBoardReference(boardCheck.text);return;}
