...
(function(){
  ...
  function updateSpeakerLabels(){document.querySelectorAll('#academyMessages .academy-message.user strong').forEach(node=>{node.textContent=learnerAddress()||'Öğrenci'})}
