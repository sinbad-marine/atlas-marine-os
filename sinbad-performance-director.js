(function(root,factory){
  ...
  function academyBoardShapeCheckHintForText(text,check,language='tr-TR'){
    ...
    const hints=turkish?{circle:'İpucu: Şeklin çevresini takip et ve keskin birleşim noktalarını say.',triangle:'İpucu: Şekli oluşturan düz kenarları birer kez takip et.',rectangle:'İpucu: Köşelerde oluşan açı türüne odaklan ve bu köşeleri say.',arrow:'İpucu: Okun sivri uç kısmına ve işaret ettiği tarafa bak.',axes:'İpucu: Yatay ve düşey çizgileri ayrı doğrultular olarak düşün.'}:{circle:'Hint: Trace the boundary and count any sharp meeting points.',triangle:'Hint: Follow each straight side that forms the shape once.',rectangle:'Hint: Focus on the type of angle at each corner and count those corners.',arrow:'Hint: Look at the pointed end of the arrow and the way it is facing.',axes:'Hint: Treat the horizontal and vertical lines as separate directions.'};
    return Object.freeze({accepted:true,known:true,hint:true,shape,text:hints[shape]});
  }
