(function(root,factory){
  ...
  function academyBoardShapeCheckRevealForText(text,check,language='tr-TR'){
    ...
    const expected=['zero','two','three','four','direction'].includes(check?.expected)?check.expected:null,turkish=String(language).toLocaleLowerCase('en-US').startsWith('tr');
    ...
    const facts=turkish?{zero:'Doğru cevap: Dairenin köşesi yoktur.',two:'Doğru cevap: Koordinat eksenleri iki temel doğrultu gösterir.',three:'Doğru cevap: Üçgenin üç kenarı vardır.',four:'Doğru cevap: Dikdörtgenin dört dik açısı vardır.',direction:'Doğru cevap: Okun uç kısmı yönü gösterir.'}:{zero:'Correct answer: A circle has no corners.',two:'Correct answer: Coordinate axes show two primary directions.',three:'Correct answer: A triangle has three sides.',four:'Correct answer: A rectangle has four right angles.',direction:'Correct answer: The head of an arrow indicates direction.'};
  ...
  function academyBoardShapeCheckReasonForText(text,check,language='tr-TR'){
    ...
    const reasons=turkish?{zero:'Çünkü dairenin çevresi kesintisiz bir eğridir; düz kenarların birleştiği bir köşe oluşturmaz.',two:'Çünkü biri yatay, diğeri düşey olan iki eksen iki temel doğrultuyu gösterir.',three:'Çünkü üçgenin kapalı sınırı üç düz kenardan oluşur.',four:'Çünkü dikdörtgenin dört köşesinin her biri dik açıdır.',direction:'Çünkü okun sivri uç kısmı, gövdesinin hangi tarafa yöneldiğini ayırt etmemizi sağlar.'}:{zero:'Because a circle has one continuous curved boundary and no corner formed by meeting straight sides.',two:'Because the horizontal and vertical axes show two primary directions.',three:'Because a triangle has a closed boundary made from three straight sides.',four:'Because each of a rectangle’s four corners is a right angle.',direction:'Because the pointed head distinguishes the direction in which the arrow shaft is oriented.'};
