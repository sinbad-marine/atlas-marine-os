(function(root,factory){
  ...
  const normalizeCoreQuestion=value=>String(value||'').trim().slice(0,6000);
  ...
  return {CORE_GATE_VERSION,normalizeCoreQuestion,analyzeCore,serverCoreDecision,validateCoreEnvelope};
});
